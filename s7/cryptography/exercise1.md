...
*
  ...
  [Μια άλλη ενδιαφέρουσα προσέγγιση](https://planetcalc.com/8047/) χρησιμοποιεί μια μορφή εξελικτικού αλγορίθμου η συνάρτηση καταλληλότητας του οποίου βασίζεται στη συχνότητα των _τετράδων γραμμάτων_ -αντί για σκέτα γράμματα- σε ένα δείγμα αγγλικού κειμένου. Όμως, δεν κατάφερε να αποκρυπτογραφήσει τα μικρά κρυπτοκείμενά μας.
