...
let designtime =
    ...
    let number: DesigntimeFarkle<Number> =
        ...
        // Το T χρειάζεται για λόγους που οφείλονται σε περιορισμούς του runtime.
    ...
    let ST =
        [
            ...
            // ανάμεσα στις λέξεις. Επίσης μπορούμε να γράψουμε Whitespace αντί για
            // PredefinedSets.Whitespace, για ευκολία.
        ...
        |> terminalU "ST"
    let X =
        // Για το X θα απαιτήσουμε να μην υπάρχει κενό μεταξύ
        // του x και του αριθμού.
        ...
        // "τυλίξουμε" σε ένα αντικείμενο τύπου X.
    ...
    // χαρακτήρες διαστήματος (κενό, tab, και αλλαγή γραμμής).
