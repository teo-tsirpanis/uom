...
2. Από τον τωρινό κόμβο του δέντρου, ανατρέχουμε προς τα πίσω μέσω των συνδέσμων ευρετηρίου, μέχρι να φτάσουμε στη ρίζα του δέντρου. Για κάθε κόμβο $x$ που συναντάμε και που η συμβολοσειρά του ανήκει στις λέξεις που θέλουμε να βρούμε, κάνουμε τα εξής:
    ...
    * Αναφέρουμε με κάποιον τρόπο ότι έχουμε βρει τη λέξη που αντιστοιχεί στον κόμβο $x$, στη θέση $matchPos$.
...
> _Σημείωση (25/9/2022):_ Τελικά δε μπορούμε να αφαιρέσουμε εντελώς την `abcd`· αν το κάναμε, στο κείμενο `abc` θα βρίσκαμε αντιστοίχιση μια θέση μετά, και ο κύριος αλγόριθμος αντιστοίχισης θα έχανε εντελώς το `abcd`. Μπορούμε όμως να την περικόψουμε στο `abc`.
